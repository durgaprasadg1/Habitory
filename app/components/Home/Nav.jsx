        ...
        {!isSignedIn ? (
          <div className="flex items-center gap-2">
            <Button
              ...
              className="border border-[#A8A29E]/50 text-[#1C1917] dark:text-white bg-[#E7E5E4] hover:bg-[#C08457] hover:text-white rounded-lg px-3 text-sm"
            >
              Register
            </Button>
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center justify-center transition-colors ${
                      active
                        ? "text-[#C08457]"
                        : "text-[#A8A29E] hover:text-[#1C1917] dark:hover:text-white"
                    }`}
                  >
                    <Icon
                      size={20}
