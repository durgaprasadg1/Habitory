      ...
      <div className="max-w-6xl mx-auto px-4 py-10 space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-sm text-[#78716C] leading-relaxed max-w-md">
            A disciplined system for tracking habits, monthly goals, and
            long-term consistency — built for structured growth.
          </p>
        </div>

        <div className="grid grid-cols-2 gap-8 text-sm">
          <div className="space-y-3">
            <h4 className="text-[#1C1917] dark:text-white font-medium">
              Product
            </h4>
            <ul className="space-y-2 text-[#78716C]">
              <li>
                <Link
                  href="/dashboard"
                  className="hover:text-[#C08457] transition-colors"
                >
                  Dashboard
                </Link>
              </li>
